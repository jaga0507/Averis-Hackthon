Master -> Extraction,Classification and Comparision of SI and BL Draft
Kirtanan -> Chatbot
...
6. Create the TitanPort Database
...
After the schema is installed, the database should contain the TitanPort tables for things such as:
cases
emails
documents
extracted_fields
...
11. Start the Python Processing Service
Open a terminal:
...
17. Testing a Matching Case
A matching test case should contain:
SI
BL
...
19. Testing a Missing Document Case
...
20. Understanding comparison: null
...
21. Finding a Case by ID
The API endpoint is:
GET /cases/{caseId}
For example:
http://localhost:8000/cases/f257fb18-2f76-5770-a982-ad9cc6047e22
The response contains the case information, documents, comparison, extracted fields, activities, review task, decisions, and audit information.
...
29. Important Note About Deployment
